package com.example.achat.activity
...
import com.example.achat.MainActivity
import com.example.achat.R
import com.example.achat.databinding.ActivityProfileBinding
    ...
    private fun uploadInfo(imgUrl: String) {
        ...
        database.reference.child("users")
            ...
            .addOnSuccessListener {
                Toast.makeText(this, "Updater Successfully", Toast.LENGTH_SHORT).show()
